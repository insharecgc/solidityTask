...
async function main() {
    ...
    const auctionProxyAddress = "0xe019f9D778a568007A50abdCB4615D12e2B81B47"    // 上面部署成功的拍卖合约代理地址
    const NFTAuctionFactory = await ethers.getContractFactory("NFTAuctionFactory");
    const nftAuctionFactoryProxy = await upgrades.deployProxy(NFTAuctionFactory, [auctionProxyAddress, deployer.address, 600], {
        initializer: "initialize",
    })
